"""
Listens to and updates monitors on Julia.

Monitor.CURRENT_CONNECTION is a ScopedValue holding the current connection during operation
...
A communication plugin must define communication handlers in order for this to work:
...
- has_updates(::Connection, ::UpdateType) -- return whether there are pending updates
